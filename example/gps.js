...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'gps.wast';
  var wasmBinaryFile = 'gps.wasm';
  var asmjsCodeFile = 'gps.temp.asm.js';
...
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_gps_cc() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } });
...
var real___GLOBAL__sub_I_gps_cc = asm["__GLOBAL__sub_I_gps_cc"]; asm["__GLOBAL__sub_I_gps_cc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_gps_cc.apply(null, arguments);
};
...
var __GLOBAL__sub_I_gps_cc = Module["__GLOBAL__sub_I_gps_cc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_gps_cc"].apply(null, arguments) };
